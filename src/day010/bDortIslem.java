...
/*      float a=4;    Metodumuzda int tanımladıgımız için floatlat geçemez. byte ve short geçebilir cünkü byte 1 byte - short 2 byte - int 4 byte.
    ...
    public static void ikiSayiyiTopla(int danteBir,int danteIki){   // methodlarımızı emir kipinde yazıyoruz.  // parantez içi PARAMETRE
        int toplam=danteBir+danteIki;
    ...
    //İki sayıyı toplayıp, sonucunu cagrıldıgı yere döndüren bir metot yazınız.
